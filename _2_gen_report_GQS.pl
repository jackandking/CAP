...
#my $g_res_time_file = "responds.csv";
...
#if( $datafile =~ m/([^\\]+)\.txt$/i)
{
	$outhtm = $g_cur_dir . "WeeklySummary_". $start_date . "_GQS.htm";
	$outcsv = $g_cur_dir . "WeeklySummary_". $start_date . "_GQS.csv";
}
...
$htm .= "<TD>No. Total</TD><TD>No. GTS</TD><TD>No. MLS</TD><TD>No. FMS</TD><TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD><TD>No. new</TD><TD>No. open</TD><TD>No. resolved</TD><TD>No. resolved last week</TD>";
$htm .= "</TR><TR>\n";
$htm .= "<TD>$total</TD>";
$htm .= "<TD>$gts</TD>";
$htm .= "<TD>$mls</TD>";
